...
namespace GD.Dtos.Report.CommonReport
{
    ...
    /// 运营-List 审核 请求Dto
    /// </summary>
    public class GetListToApproveRequest : BasePageRequestDto
    {
        /// <summary>
        ///  申请人Guid
        /// </summary>
    ...
    ///  响应Dto
    /// </summary>
    public class GetListToApproveResponseDto : BasePageResponseDto<GetListToApproveItemDto>
    {
    }
    /// <summary>
    ///  子项Dto
    /// </summary>
    public class GetListToApproveItemDto : BaseDto
    {
        /// <summary>
        ///  报表主题Guid
        /// </summary>
