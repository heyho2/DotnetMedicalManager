...
namespace GD.Dtos.Report.CommonReport
{
    ...
    /// 编辑
    /// </summary>
    public class UpdateOneReportRequest
    {
        ///<summary>
        ///报表主键
        ///</summary>
        ...
        public List<UpdateConditionInfo> CreateConditionInfoList { set; get; }

        /// <summary>
        /// 显示列信息列表
        /// </summary>
        [Required(ErrorMessage = "{0}必填"), Display(Name = "显示列信息列表")]
        public List<UpdateColumnInfo> CreateColumnInfoList { set; get; }
        /// <summary>
        ...
        /// 条件信息
        /// </summary>
        public class UpdateConditionInfo
        {
            /// <summary>
            /// 条件名
            /// </summary>
