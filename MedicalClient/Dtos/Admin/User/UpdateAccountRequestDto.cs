...
namespace GD.Dtos.Admin.User
{
    ...
    /// 添加账号
    /// </summary>
    public class UpdateAccountRequestDto : BaseDto
    {
        ///<summary>
        ///GUID
        ///</summary>
        [Required(ErrorMessage = "{0}必填"), Display(Name = "GUID")]
        ...
        ///密码
        ///</summary>
        [MaxLength(32, ErrorMessage = "请输入正确的Md5值"), MinLength(32, ErrorMessage = "请输入正确的Md5值")]
