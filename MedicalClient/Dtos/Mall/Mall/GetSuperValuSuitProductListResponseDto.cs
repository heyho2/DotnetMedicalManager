...
namespace GD.Dtos.Mall.Mall
{
    ...
    /// 生美-获取超值优惠列表
    /// </summary>
    public class GetSuperValuSuitProductListRequestDto:BasePageRequestDto
    {
        /// <summary>
        /// 分类枚举
        /// </summary>
    ...
    /// 响应Dto
    /// </summary>
    public class GetSuperValuSuitProductListResponseDto : BasePageResponseDto<GetSuperValuSuitProductItem>
    {
    ...
    /// 子项
    /// </summary>
    public class GetSuperValuSuitProductItem : BaseDto
    {
        /// <summary>
        /// 分类Guid
        /// </summary>
