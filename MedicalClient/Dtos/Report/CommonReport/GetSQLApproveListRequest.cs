...
namespace GD.Dtos.Report.CommonReport
{
    ...
    /// 审核SQL
    /// </summary>
    public class GetSQLApproveListRequest : BasePageRequestDto
    {
        /// <summary>
        ///  申请人Guid
        /// </summary>
    ...
    /// 响应Dto
    /// </summary>
    public class GetSQLApproveListResponse : BasePageResponseDto<GetSQLApproveListItemDto>
    {
    ...
    /// 子项
    /// </summary>
    public class GetSQLApproveListItemDto : BaseDto
    {
        /// <summary>
        ///   报表主题Guid
        /// </summary>
