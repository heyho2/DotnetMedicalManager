...
namespace GD.Module.CommonUtility
{
    public class HttpClientHelper
    {
        ...
        /// <returns></returns>
        public static async System.Threading.Tasks.Task<T> HttpGetAsync<T>(string url)
        {
        ...
        /// <returns></returns>
        public static System.Threading.Tasks.Task<string> HttpPostAsync(string url, string xml, string CertPath, string CAPassword)
        {
            try
            {
